...
function mainLoad()
	...
	if IsSACReborn then
		SkillQ = AutoCarry.Skills:NewSkill(false, _Q, qRange, qName, AutoCarry.SPELL_LINEAR, 0, false, false, qSpeed, qDelay, qWidth, false)
		SkillE = AutoCarry.Skills:NewSkill(false, _E, eRange, eName, AutoCarry.SPELL_CIRCLE, 0, false, false, eSpeed, eDelay, eWidth, false)
	else
