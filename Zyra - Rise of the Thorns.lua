--[[
        Zyra: Rise of the Thorns - PROdiction Edition
		Author: Kain
...
function Vars()
	...
	if VIP_USER then
		if FileExist(SCRIPT_PATH..'Common/Prodiction.lua') then
			...
			tpQ = SetupPROdiction(_Q, QRange, QSpeed, QDelay, QWidth, myHero,
			...
			PrintChat("<font color='#CCCCCC'> >> Kain's Zyra - Prediction 2.0 Loaded <<</font>")
		else
